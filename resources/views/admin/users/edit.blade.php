                                    ...
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <select name="spouse_genre">
                                                <option
                                                    value="male" {{ old('genre') == 'male' ? 'selected' : ($user->spouse_genre == 'male' ? 'selected' : '') }}>
                                                    Masculino
                                                </option>
                                                <option
                                                    value="female" {{ old('genre') == 'female' ? 'selected' : ($user->spouse_genre == 'female' ? 'selected' : '') }}>
                                                    Feminino
                                                </option>
                                                <option
                                                    value="other" {{ old('genre') == 'other' ? 'selected' : ($user->spouse_genre == 'other' ? 'selected' : '') }}>
                                                    Outros
                                                </option>
                                            </select>
                                        </label>
