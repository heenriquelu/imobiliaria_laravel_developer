                                ...
                                <div class="app_collapse_content d-none">
                                    <div class="label_g2">
                                        ...
                                        <label class="label">
                                            ...
                                            <input type="tel" name="cellphone" class="mask-cell"
                                                   placeholder="Número do Telefonce com DDD" value="{{ old('cellphone') ?? $user->cellphone }}"/>
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="app_collapse_content d-none content_spouse">
                                    ...
                                    <label class="label">
                                        ...
                                        <select name="type_of_communion" class="select2">
                                            <option value="Comunhão Universal de Bens" {{ old('type_of_communion') == 'Comunhão Universal de Bens' ? 'selected' : ($user->type_of_communion == 'Comunhão Universal de Bens' ? 'selected' : '') }}>Comunhão Universal de Bens
                                            </option>
                                            ...
                                            <option value="Participação Final de Aquestos" {{ old('type_of_communion') == 'Participação Final de Aquestos' ? 'selected' : ($user->type_of_communion == 'Participação Final de Aquestos' ? 'selected' : '') }}>Participação Final de
                                                Aquestos
                                            </option>
                                        </select>
                                    </label>
                                    ...
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <select name="spouse_genre">
                                                <option value="male" {{ old('genre') == 'male' ? 'selected' : ($user->spouse_genre == 'male' ? 'selected' : '') }}>Masculino</option>
                                                <option value="female" {{ old('genre') == 'female' ? 'selected' : ($user->spouse_genre == 'female' ? 'selected' : '') }}>Feminino</option>
                                                <option value="other" {{ old('genre') == 'other' ? 'selected' : ($user->spouse_genre == 'other' ? 'selected' : '') }}>Outros</option>
                                            </select>
                                        </label>
                                ...
                                <div class="app_collapse_content">
                                    ...
                                    <div class="companies_list">
                                        ...
                                        <div class="companies_list_item mb-2">
                                            <p><b>Razão Social:</b> LH Info Web</p>
                                            <p><b>Nome Fantasia:</b> LH Info Web</p>
                                            <p><b>CNPJ:</b> 00.000.000/0001-00 - <b>Inscrição Estadual:</b> -
                                            </p>
                                            <p><b>Endereço:</b> Rua Lorem, -
                                                </p>
                                            <p><b>CEP:</b> 35164-000 <b>Bairro:</b> Bethânia <b>Cidade/Estado:</b>
                                                Ipatinga/MG</p>
                                        </div>
                                    </div>
