                    ...
                    <div class="nav_tabs_content">
                                    ...
                                    <div class="label_g2">
                                        ...
                                        <label class="label">
                                            ...
                                            <input type="tel" name="cellphone" class="mask-cell"
                                                   placeholder="Número do Telefonce com DDD" value="{{ old('cellphone') }}"/>
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="management" class="d-none">
                            <div class="label_gc">
                                ...
                                <label class="label">
                                    <input type="checkbox" name="admin" {{ old('admin') == 'on' || old('lessor') == true ? 'checked' : '' }}><span>Administrativo</span>
                                </label>

                                <label class="label">
                                    <input type="checkbox" name="client"  {{ old('client') == 'on' || old('lessor') == true ? 'checked' : '' }}><span>Cliente</span>
                                </label>
                            </div>
                        </div>
                    </div>
